...
This is required for the Elastic Net regularizer presented in the main research study.  It would have been possible
using l1 and l2 regularization but less direct and obvious what was happening if that was the implementation.
"""
